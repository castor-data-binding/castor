...
/**
 * Tests {@link NatureExtendable} capabilities of FieldInfo.
 * 
 * @author Lukas Lang
 *
 */
public final class FieldInfoNatureExtendableTest extends BaseNatureExtendableTest {
  ...
  protected void setUp() throws Exception {
    ...
    _extender = factory.createFieldInfo(new XSClass(new JClass("Book")), "isbn");
  }
}
