...
/**
 * Child class of {@link SourceGenerator} that allows access to the {@link SGStateInfo} class(es) as
 * maintained by the source generator.
 * 
...
public class ExtendedSourceGenerator extends SourceGenerator {
  ...
  /**
   * Get the current state of the {@link SourceFactory} used by this SourceGenerator.
   * 
