...
/**
 * Tests the set/get capabilities of a PropertyHolder. Subclasses MUST override the setUp method and
 * set a PropertyHolder to _holder. The testcase needs a "fresh" NatureExtendable to guarantee
 * independence for each test.
 * 
 * @author Lukas Lang
 * @since 1.2.1
 * 
