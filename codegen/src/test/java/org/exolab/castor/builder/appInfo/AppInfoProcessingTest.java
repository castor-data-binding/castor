...
/**
 * Test case for testing processing appinfo elements and storing their values in {@link ClassInfo}
 * /FieldInfo instances using Natures.
 * 
 * @author Lukas Lang
 * @since 1.2.1
 */
public class AppInfoProcessingTest extends TestCase {
  ...
  /**
   * This method tests the processing of AppInfos from a very basic Schema file. The Schema file
   * contains a single <code>element</code> definition and doesen't contain a top-level, named
   * complex type. The element doesen't have any attributes either.
   * 
  ...
  public final void testAppInfoProcessingWithSimpleSchema() throws Exception {
    ...
    _generator.generateSource(inputSource, getClass().getPackage().getName() + ".generated.simple");
    ...
    /*
     * Get all elements (=keys) the ClassInfoResolver knows of. For these keys the SourceGenerator
     * created ClassInfos in which we are interested.
     */
    ...
    /*
     * Get all ClassInfos. Note that during the source generation process ClassInfos are actually
     * added twice to the ClassInfoResolver's cache: - once with the XMLBindingComponent/ClassInfo -
     * and with the JClass/ClassInfo as key/value pair. Therefore we only get those ClassInfos with
     * a XMLBindingComponent/ClassInfo pair to avoid duplicates!
     */
    ...
    ///////// FieldInfo
    /*
     * There should be 3 FieldInfos: - ssnr - firstName - lastName
     */
  ...
  /**
   * This method tests the processing of AppInfos from a Schema that describes a Book. The Schema
   * consists of a global element whose type is described by a global <code>complexType</code>
   * definition consisting of two sub-elements and an attribute.
   * 
   * @throws Exception if an error occurs
   */
  public final void testAppInfoProcessingWithEntitySchema() throws Exception {
    ...
    InputSource inputSource = new InputSource(_xmlSchema);
    _generator.generateSource(inputSource, getClass().getPackage().getName() + ".generated.entity");
    ...
    for (int i = 0; i < cInfos.size(); ++i) {
      ...
      if (xmlNature.getNodeName().equals("book")) {
        /*
         * No JDO-specific information should be stored to this ClassInfo.
         */
        ...
        ///////// FieldInfo
        /*
         * There should be 3 FieldInfos: - coverType (attribute field) - isbn - title
         */
        assertEquals(3, cInfo.getFieldCount());
  ...
  public final void testAppInfoProcessingWithEntityAndSolrjSchema() throws Exception {
    ...
    InputSource inputSource = new InputSource(_xmlSchema);
    _generator.generateSource(inputSource, getClass().getPackage().getName() + ".generated.solrj");
  ...
  public final void testAppInfoProcessingNoJDOContent() throws Exception {
    ...
    InputSource inputSource = new InputSource(_xmlSchema);
    _generator.generateSource(inputSource, getClass().getPackage().getName() + ".generated.noJDO");
  ...
  public final void testAppInfoProcessingWithComplexContent() throws Exception {
    ...
    InputSource inputSource = new InputSource(_xmlSchema);
    _generator.generateSource(inputSource,
        getClass().getPackage().getName() + ".generated.complexContent");
