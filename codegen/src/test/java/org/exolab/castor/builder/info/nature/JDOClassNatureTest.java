 ...
 * behavior of properties not set before is specified in the {@link BaseNature} class and tested in
 * {@link BaseNatureTest}. Property implementation will not be tested in here.
 * 
...
public final class JDOClassNatureTest extends TestCase {
  ...
  /**
   * Tests set and get primary keys. Adding the author column to the primary key in reality would
   * net really make sense.
   */
  ...
  public void testGetElementFields() {
    ...
    FieldInfo field = factory.createFieldInfo(new XSClass(new JClass("Book")), "isbn");
    ...
    JDOFieldInfoNature jdoFieldReceived = (JDOFieldInfoNature) jdoFields.get(0);
  ...
  public void testGetElementFieldsWithMoreThanOneField() {
    ClassInfo classInfo = new ClassInfo(new JClass("test"));
    FieldInfoFactory factory = new FieldInfoFactory();
    FieldInfo isbn = factory.createFieldInfo(new XSClass(new JClass("Book")), "isbn");
    FieldInfo title = factory.createFieldInfo(new XSClass(new JClass("Book")), "title");
  ...
  /**
   * Test getFields with a ClassInfo having a FieldInfo but without JDOFieldInfoNature.
   */
  ...
  public void testGetElementFieldsOnlyOneHasNature() {
    ...
    FieldInfoFactory factory = new FieldInfoFactory();
    FieldInfo field = factory.createFieldInfo(new XSClass(new JClass("Book")), "isbn");
    FieldInfo field2 = factory.createFieldInfo(new XSClass(new JClass("Book")), "abc");
    field.addNature(JDOFieldInfoNature.class.getName());
    JDOFieldInfoNature jdoField = new JDOFieldInfoNature(field);
    jdoField.setColumnName("isbn");
    jdoField.setColumnType("integer");
  ...
  public void testGetAttributeTextElementFields() {
    ...
    FieldInfo elementField = factory.createFieldInfo(new XSClass(new JClass("Book")), "isbn");
    // Set node type
    ...
    FieldInfo attributeField = factory.createFieldInfo(new XSClass(new JClass("Book")), "title");
    // Set node type
    ...
    FieldInfo textField = factory.createFieldInfo(new XSClass(new JClass("Book")), "price");
    // Set node type
