...
public final class JPrimitiveType extends JType {
  ...
  /**
   * Only populated for primitive types and indicates the wrapper Object class name for this
   * primitive type.
   */
  ...
  /**
   * Creates a new JPrimitiveType for a primitive with the given name and wrapper name. This
   * constructor is protected so it can only be used by the primitives defined at JType.
   *
