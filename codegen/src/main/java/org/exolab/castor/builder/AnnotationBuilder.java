 ...
 * 
 * Custom implementations of {@link AnnotationBuilder} instances can be added to a code generation
 * execution using {@link SourceGenerator#addAnnotationBuilder(AnnotationBuilder)}
 * 
 * @since 1.1.3
 */
