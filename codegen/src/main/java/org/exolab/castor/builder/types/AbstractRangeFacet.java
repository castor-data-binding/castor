...
public abstract class AbstractRangeFacet extends AbstractWhiteSpaceFacet {
   ...
   * 
   * @return The maximum exclusive value that this XSDate can hold. If no maximum exclusive value
   ...
   * 
   * @return The maximum inclusive value that this XSDate can hold. If no maximum inclusive value
   *         has been set, Null will be returned.
   */
   ...
   * 
   * @return The minimum exclusive value that this XSDate can hold. If no minimum exclusive value
   *         has been set, Null will be returned.
   */
