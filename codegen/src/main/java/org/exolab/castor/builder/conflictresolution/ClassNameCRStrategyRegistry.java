...
/**
 * Registry for {@link ClassNameCRStrategy} implementations obtained from the Castor builder
 * properties file.
 *
...
public final class ClassNameCRStrategyRegistry {
  ...
  /**
   * Association between name of {@link ClassNameCRStrategy} implementation and
   * {@link ClassNameCRStrategy} instance.
   */
  ...
  /**
   * Construct an instance of {@link ClassNameCRStrategyRegistry} that loads the
   * {@link ClassNameCRStrategy} implementations specified in the given BuilderConfiguration.
   *
    ...
    while (tokenizer.hasMoreTokens()) {
      ...
      try {
        ...
        LOG.error("The ClassNameConflictResolutionStrategy " + classname + " "
            + "specified in the Castor builder properties file could not " + "be instantiated.");
      }
    }
  }
  ...
  /**
   * Returns the names of all the configured {@link ClassNameCRStrategy} implementations. A
   * {@link ClassNameCRStrategy} instance can be obtained by the
   * {@link #getClassNameConflictResolutionStrategy} method.
   *
  ...
  /**
   * Returns a {@link ClassNameCRStrategy} with the specified name. Returns null if the named
