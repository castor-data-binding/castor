...
/**
 * Helper class to assemble an XPATH expression to qualify the path of an XML schema structure from
 * the XML schema root.
 * 
...
public class XPathHelper {
  ...
  /**
   * Initial size of the {@link StringBuffer} used to asseble the XPATH expression.
   */
   ...
   */
  public static void getSchemaLocation(final Structure structure, final StringBuffer location) {
   ...
   * @param structure AN XML structure.
   * @param location The XPATH expression to be created.
   * @param dealWithAnonTypes Indicates whether to include XPATH fragments for anonymous types.
   */
  public static void getSchemaLocation(final Structure structure, final StringBuffer location,
  ...
  /**
   * Returns a string (XPATH) representation of an XML Schema component. This representation is
   * directly adapted from XPath and will used as a key to store the component bindings.
   * <p>
   ...
   * <ul>
   * <li>If the structure is an <b>Element</b>: the location is the XPath representation
   * "/element_name"</li>
   * <li>If the structure is an <b>Attribute</b>: the location is the XPath representation
   * "/@attribute_name"</li>
   * <li>If the structure is a <b>ComplexType</b>: the location is "complexType:complexType_name"
   * </li>
   * <li>If the structure is a <b>SimpleType</b>: the location is "simpleType:simpleType_name"</li>
   * <li>If the structure is a <b>Enumeration</b>: the location is "enumType:enumType_name"</li>
   * <li>If the structure is a <b>ModelGroup</b>: the location is "group:group_name"</li>
   * </ul>
