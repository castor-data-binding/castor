...
public abstract class BaseClassNameConflictResolver implements ClassNameConflictResolver {
  ...
  /**
   * Calling {@link SourceGenerator} instance, used to retrieve configuration information.
   */
   ...
   */
  public abstract void changeClassInfoAsResultOfConflict(final JClass jClass, final String xpath,
