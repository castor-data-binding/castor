...
/**
 * {@link JClassPrinterFactory} instance that returns standard 'Writer'-based {@link JClassPrinter}
 * instances. This is currently the default {@link JClassPrinterFactory} instance used for code
 * generation, but will be replaced in the foreseeable future.
 * 
 * @since 1.2.1
 */
