...
/**
 * A JDO specific view of a {@link ClassInfo}. Implementation on property based {@link ClassInfo}
 * access.
 * 
...
public final class JDOClassInfoNature extends BaseNature {
  ...
  /**
   * @param classInfo the classinfo in focus.
   */
  ...
  /**
   * Returns a List of {@String}s holding the columns of the primary key. Keep in mind that by
   * contract of <code>addPrimaryKey(String primaryKey)</code> the order is not guaranteed.
   * 
   * @return the names of the primary key's columns or null if no key added before.
   */
   ...
   * 
   * @param tableName of the SQL table.
   */
  ...
  /**
   * Sets the {@link org.exolab.castor.mapping.AccessMode} to the given AccessMode.
   * 
  ...
  /**
   * Returns a List of {@link JDOFieldInfoNature}s of all {@link FieldInfo}s if the field has a a
   * {@link JDOFieldInfoNature} or an empty List if no field has the Nature. Included are attribute,
   * text and element fields.
   * 
