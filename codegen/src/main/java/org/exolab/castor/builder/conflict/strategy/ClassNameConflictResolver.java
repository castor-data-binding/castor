...
public interface ClassNameConflictResolver {
   ...
   * @param typedXPath XPATH expression used to defer the new local class name
   * @param annotated {@link Annotated} instance
   */
  void changeClassInfoAsResultOfConflict(final JClass jClass, final String xpath, String typedXPath,
      Annotated annotated);
