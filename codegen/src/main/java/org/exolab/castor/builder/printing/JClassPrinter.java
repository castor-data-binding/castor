...
/**
 * Interface for printing {@link JClass} instances as Java source code to the file system.
 */
public interface JClassPrinter {
   ...
   */
  void printClass(final JClass jClass, final String outputDir, final String lineSeparator,
      final String header);
