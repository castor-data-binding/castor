...
public abstract class AbstractLengthFacet extends AbstractWhiteSpaceFacet {
  ...
  /**
   * Construct a new AbstractXSLengthFacet optionally allowing the whiteSpace facet to be set to
  ...
  /**
   * Sets the length of this type. While setting the length, the maxLength and minLength are also
  ...
  /**
   * Returns the maximum length occurances of this type can be. A negative value denotes no maximum
   * length.
   * 
