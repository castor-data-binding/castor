...
public abstract class AbstractWhiteSpaceFacet extends AbstractPatternFacet {
  ...
  /**
   * If set to true only 'collapse' is allowed for the whiteSpace facet. If set to false 'collaps',
   * 'replace' and 'preserve' values are allowed for whiteSpace facet.
   */
  ...
  /**
   * Construct a new AbstractXSPatternFacet optionally allowing the whiteSpace facet to be set to
   * 'replace' and 'preserve' values in addition to 'collaps'.
   *
  ...
  /**
   * Sets the whiteSpace facet of this XSType. The value of the whiteSpace facet must be one of the
   * following:
   * <ul>
   * <li>preserve</li>
   * <li>replace</li>
