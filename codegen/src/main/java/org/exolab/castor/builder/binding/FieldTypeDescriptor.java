...
extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public FieldTypeDescriptor() {
        ...
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        org.exolab.castor.xml.validators.BooleanValidator typeValidator3 =
            new org.exolab.castor.xml.validators.BooleanValidator();
        fieldValidator.setValidator(typeValidator3);
        desc.setValidator(fieldValidator);
        //-- _handler
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(
        ...
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        org.exolab.castor.xml.validators.StringValidator typeValidator4 =
            new org.exolab.castor.xml.validators.StringValidator();
        typeValidator4.setWhiteSpace("preserve");
        fieldValidator.setValidator(typeValidator4);
        desc.setValidator(fieldValidator);
        //-- _collection
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(
        ...
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        org.exolab.castor.xml.validators.StringValidator typeValidator5 =
            new org.exolab.castor.xml.validators.StringValidator();
        typeValidator5.setWhiteSpace("preserve");
        fieldValidator.setValidator(typeValidator5);
        desc.setValidator(fieldValidator);
