...
public final class XMLInfoNature extends BaseNature {
   ...
   * 
   * @return the XML name for the object described by this XMLInfo, or null if no name has been set
   */
   ...
   * 
   * @return the name of the node-type of the object described by this XMLInfo.
   */
   ...
   * once in the XML document). Returns false if the property was not set.
   * 
   * @return true if this object can appear more than once, false if not or not set.
   */
   ...
   * document (or object model). Returns false if the property was not set.
   * 
   * @return true if the XML object must appear at least once, false if not or not set.
   */
   ...
   * 
   * @param elementDef The flag indicating whether or not XSD is global element, element with
   *        anonymous type or not.
   */
   ...
   * 
   * @param multivalued The boolean indicating whether or not the object can appear more than once.
   */
   ...
   * 
   * @param required the flag indicating whether or not this XML object is required
   */
   ...
   * 
   * @param substitutionGroups Possible substitution groups.
   */
  ...
  /**
   * Returns true if this ClassInfo describes a container class. A container class is a class which
  ...
  /**
   * Sets whether or not this ClassInfo describes a container class. A container class is a class
   * which should not be marshalled as XML, but whose members should be. By default this is false.
   *
