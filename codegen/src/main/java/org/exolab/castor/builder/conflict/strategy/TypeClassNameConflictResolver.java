...
/**
 * Class name conflict resolver implementation, adding a By&lt;Type&gt; suffix to the suggested
 * class name.
 * 
 * @author <a href="mailto:werner DOT guttmann AT gmx DOT net">Werner Guttmann</a>
 */
public class TypeClassNameConflictResolver extends BaseClassNameConflictResolver
   ...
   */
  public void changeClassInfoAsResultOfConflict(final JClass jClass, final String xpath,
      final String typedXPath, final Annotated annotated) {
    String typeString = typedXPath.substring(typedXPath.indexOf("[") + 1, typedXPath.indexOf("]"));
    ...
    if (typeString.startsWith("/complexType:anon")) {
      ...
      // set new classname
      String newClassName =
          jClass.getLocalName() + getSourceGenerator().getAutomaticConflictResolutionTypeSuffix()
