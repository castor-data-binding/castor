 ...
 */
public class Root_ObjectDescriptor extends org.exolab.castor.tests.framework.testDescriptor.descriptors.RootTypeDescriptor {
    ...
    public Root_ObjectDescriptor() {
        super();
        setExtendsWithoutFlatten(new org.exolab.castor.tests.framework.testDescriptor.descriptors.RootTypeDescriptor());
        _nsURI = "http://castor.exolab.org/Test";
        _xmlName = "Root_Object";
