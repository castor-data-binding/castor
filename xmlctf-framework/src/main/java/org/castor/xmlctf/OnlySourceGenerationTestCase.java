...
/**
 * This class encapsulate all the logic to run the tests patterns for the source generator. It is
 * able to run the source generator by itself and then compile the file that have been generated.
 * This class does not do anything additional. It only runs the source generator and ensures that
 * the generated source will compile without error.
 *
