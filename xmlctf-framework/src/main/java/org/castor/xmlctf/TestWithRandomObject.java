 ...
 * generated source to write a randomly generated XML element to a file.
 * <p>
...
class TestWithRandomObject extends TestCase {
  ...
  public void runTest() throws Exception { // FIXME - temporarily throws Exception
    ...
    if (_delegate._hasDump) {
      ...
      FileWriter writer =
          new FileWriter(new File(_delegate._outputRootFile, _outputName + "-ref.dump"));
    ...
    if (_delegate._hasDump) {
      ...
      FileWriter writer =
          new FileWriter(new File(_delegate._outputRootFile, _outputName + "-unmar.dump"));
   ...
   */
  private CastorTestable getRandomizedReference()
