 ...
 * @since 1.1
 */
public final class PointBaseSchemaFactory implements SchemaFactory {
    //--------------------------------------------------------------------------
     ...
     * {@inheritDoc}
     */
    public Field createField() { return new PointBaseField(); }
     ...
     * {@inheritDoc}
     */
    public PrimaryKey createPrimaryKey() { return new PointBasePrimaryKey(); }
