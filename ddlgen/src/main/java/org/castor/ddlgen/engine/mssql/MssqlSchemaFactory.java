 ...
 * @since 1.1
 */
public final class MssqlSchemaFactory implements SchemaFactory {
    //--------------------------------------------------------------------------
     ...
     * {@inheritDoc}
     */
    public Field createField() { return new MssqlField(); }
     ...
     * {@inheritDoc}
     */
    public PrimaryKey createPrimaryKey() { return new MssqlPrimaryKey(); }
