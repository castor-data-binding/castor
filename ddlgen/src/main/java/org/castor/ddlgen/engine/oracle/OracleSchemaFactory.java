...
import org.castor.ddlgen.schemaobject.DefaultField;
 ...
 * @since 1.1
 */
public final class OracleSchemaFactory implements SchemaFactory {
    //--------------------------------------------------------------------------
     ...
     * {@inheritDoc}
     */
    public Field createField() { return new DefaultField(); }
