 ...
 */
public final class TestSybaseQueryVisitor extends TestPostgreSQLQueryVisitor {
    //---------------------------SELECT--------------------------------------------------------
    ...
    public void testSelectNoConditionNoExpressionWithLock() throws Exception {
        ...
        String expected = "SELECT * FROM \"TestTable\" HOLDLOCK";
    ...
    public void testSelectWithJoinsDepthWithLock() {
        ...
        sel.setLocked(true);
        queryVis.visit(sel);
        assertEquals("SELECT * FROM \"FOO\" HOLDLOCK", queryVis.toString());
    ...
    public void testSelectWithJoinsBreadthWithLock() {
        ...
        assertEquals("SELECT * FROM "
                + "((((\"FOO\" HOLDLOCK INNER JOIN \"BAR\" HOLDLOCK ON "
                + "\"FOO\".\"ID\"=\"BAR\".\"ID\") "
                + "INNER JOIN \"ABC\" \"xyz\" HOLDLOCK ON \"FOO\".\"ID\"=\"xyz\".\"ID\") "
                + "INNER JOIN \"tab4\" HOLDLOCK) "
                + "INNER JOIN \"tab5\" HOLDLOCK)", queryVis.toString());
    }
    ...
    public void testSelectWithJoinsDepthAndBreadthWithLock() {
      ...
      assertEquals("SELECT * FROM "
              + "((\"table1\" HOLDLOCK INNER JOIN "
              + "((\"table2\" HOLDLOCK FULL JOIN \"table3\" HOLDLOCK ON "
              + "\"table2\".\"col2\"=\"table3\".\"col3\") "
              + "LEFT JOIN \"table7\" HOLDLOCK ON \"table2\".\"col2\"=\"table7\".\"col7\") "
              + "ON \"table1\".\"col1\"=\"table2\".\"col2\") "
              + "INNER JOIN (\"table4\" HOLDLOCK "
              + "RIGHT JOIN (\"table5\" HOLDLOCK LEFT JOIN \"table6\" HOLDLOCK "
    ...
    public void testSelectWithFromWithLock() {
        ...
        assertEquals("SELECT * "
                + "FROM \"FOO\" HOLDLOCK, \"BAR\" HOLDLOCK, "
                + "\"ABC\" \"xyz\" HOLDLOCK", queryVis.toString());
    }
    ...
    public void testVisitJoinWithLock() throws Exception {
        ...
        assertEquals("LEFT JOIN \"tab1\" HOLDLOCK ON \"tab1\".\"col1\"=\"tab2\".\"col2\"",
                queryVis.toString());
    }
    ...
    public void testHandleJoinConstructionWithLock() {
        ...
        ((SybaseQueryVisitor) queryVis).handleJoinConstruction(table);

        assertEquals("\"tab1\" HOLDLOCK", queryVis.toString());
        ...
        assertEquals("(\"tab1\" HOLDLOCK FULL JOIN \"tab2\" HOLDLOCK ON "
                + "\"tab1\".\"col1\"=\"tab2\".\"col2\")",
                queryVis.toString());
    }
    ...
    public void testHandleJoinConstructionDepthWithLock() {
        ...
        assertEquals("(\"tab1\" HOLDLOCK FULL JOIN "
                + "(\"tab2\" HOLDLOCK FULL JOIN "
                   + "(\"tab3\" HOLDLOCK FULL JOIN \"tab4\" HOLDLOCK ON "
                   + "\"tab3\".\"col3\"=\"tab4\".\"col4\") "
    ...
    public void testHandleJoinConstructionBreadthWithLock() {
        ...
        assertEquals("((("
                + "\"tab1\" HOLDLOCK FULL JOIN \"tab2\" HOLDLOCK ON "
                + "\"tab1\".\"col1\"=\"tab2\".\"col2\") "
                + "FULL JOIN \"tab3\" HOLDLOCK ON \"tab2\".\"col2\"=\"tab3\".\"col3\") "
                + "FULL JOIN \"tab4\" HOLDLOCK ON \"tab3\".\"col3\"=\"tab4\".\"col4\")",
                queryVis.toString());
    }
    ...
    public void testHandleJoinConstructionDepthAndBreadthWithLock() {
        ...
        assertEquals("("
                + "(\"tab1\" HOLDLOCK FULL JOIN "
                    + "(\"tab2\" HOLDLOCK FULL JOIN \"tab3\" HOLDLOCK ON "
                    + "\"tab2\".\"col2\"=\"tab3\".\"col3\")"
    ...
    public void testAddTableNamesWithLock() {
        ...
        ((SybaseQueryVisitor) queryVis).addTableNames(table);

        assertEquals("\"TestTable\" HOLDLOCK", queryVis.toString());
        ...
        ((SybaseQueryVisitor) queryVis).addTableNames(tblAls);

        assertEquals("\"TestTable\" \"TestTableAlias\" HOLDLOCK",
                queryVis.toString());
    }
    ...
    public void testQuoteName() throws Exception {
        ...
        assertEquals(("\"" + expected + "\""),
                ((SybaseQueryVisitor) queryVis).quoteName(expected));
    }
    ...
    public void testGetSequenceNextValString() throws Exception {
        ...
        assertEquals(null, ((SybaseQueryVisitor) queryVis).getSequenceNextValString(name));
    }
    ...
    public void testHandleLock() throws Exception {
        ...
        Visitor queryVis = getVisitor();
        ((SybaseQueryVisitor) queryVis).handleLock(select);
