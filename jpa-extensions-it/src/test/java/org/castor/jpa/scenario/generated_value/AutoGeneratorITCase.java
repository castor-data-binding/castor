...
@Transactional
public class AutoGeneratorITCase {
	...
	@Test 
	@Transactional
	public void autoAnnotatedClassGetsIdFromDefaultTableGenerator() throws Exception {
		createPersistentObject(AutoAnnotatedClass.class);
		AutoAnnotatedClass loaded = loadPersistentObject(AutoAnnotatedClass.class);
