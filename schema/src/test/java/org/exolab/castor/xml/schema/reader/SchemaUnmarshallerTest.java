...
/**
 * This test is a integration test. It verifies whether a SchemaUnmarshaller correctly unmarshalles
 * a JDO annoted Schema. As a test Schema it uses a Schema with an element declaration referring to
 * a complexType including various elements.
 * 
 * @author Lukas Lang
 * 
 */
public class SchemaUnmarshallerTest extends TestCase {
  ...
  /**
   * Test tries to unmarshall jdo specific content in appinfo elements within a complete annoted
   * schema.<br>
   * <br>
   * Action: Parse an annoted schema.<br>
   * Precondition: schema-entity.xml holds a correct annoted schema with appinfo content.<br>
   * Postcondition: The complexType bookType holds a table object in it's annotations. The element
   * declaration of isbn holds a column object. The element declaration of title also holds a column
   * object.
   * 
   * @throws IOException
   * @throws SAXException
  ...
  /**
   * Test tries to unmarshall non-jdo specific content in appinfo elements within a complete annoted
   * schema.<br>
   * <br>
   * Action: Parse an annoted schema.<br>
   * Precondition: schema-entity-non-jdo.xml holds a correct annoted schema with NO JDO content.<br>
   * Postcondition: The complexType bookType, isbn and title have no jdo-specific content in it's
   * annotations.
   * 
   * @throws IOException
   * @throws SAXException
   ...
   * <br>
   * Action: Parse an annoted schema.<br>
   * Precondition: schema-entity-mixed.xml holds a correct annoted schema with NO JDO content, but
   * encapsulated JDO elements.<br>
   * Postcondition: The complexType bookType, isbn and title have no jdo-specific content in it's
   * annotations.
   * 
   * @throws IOException
   ...
   * <br>
   * Action: Parse an annoted schema.<br>
   * Precondition: schema-one-to-many.xml holds a correct annoted schema with appinfo content.<br>
   * Postcondition: The complexType bookType holds a table object in it's annotations. The element
   * declaration of isbn holds a column object. The element declaration of title also holds a column
   * object. The element declaration of author holds a one-to-many object.
   * 
   * @throws IOException
   * @throws SAXException
   */
  ...
  public void testDomainObjectReflectionInstantiation() {
    try {
      Table table =
          (Table) Class.forName("org.exolab.castor.xml.schema.annotations.jdo.Table").newInstance();
      table.setName("book");
  ...
  /**
   * Helper method that (manually) unmarshals an XML schema and returns a {@link Schema} object
   * instance.
   * 
