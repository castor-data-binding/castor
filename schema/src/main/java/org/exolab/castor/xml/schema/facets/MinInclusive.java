...
/**
 * An implementation of <b>minInclusive</b> constraining facet, defined in section "<a href="
 * http://www.w3.org/TR/xmlschema-2/#rf-minExclusive">4.3.10 minInclusive</a>" of "<a href="
 * http://www.w3.org/TR/xmlschema-2/">XML Schema Part 2: Datatypes Second Edition</a>" document.
 *
 * <p>
 * [Definition:] <b>minInclusive</b> is the <i>inclusive lower bound</i> of the <i>value space</i>
 * for a datatype with the <i>ordered</i> property. The value of <b>minInclusive</b> <i>must</i> be
...
public final class MinInclusive extends Facet {
   ...
   *
   * <p>
   * <i>minInclusive</i> can override the following facets of the base data type:
   *
   * <ul>
   ...
   * http://www.w3.org/TR/xmlschema-2/#minInclusive-coss">4.3.10.4 Constraints on minInclusive
   * Schema Components</a>" of "<a href="http://www.w3.org/TR/xmlschema-2/">XML Schema Part 2:
  ...
  public void checkConstraints(final Enumeration localFacets, final Enumeration baseFacets)
    ...
    while (localFacets.hasMoreElements()) {
      ...
      if (otherName.equals(Facet.MAX_EXCLUSIVE) && getOwningType().isNumericType()
        ...
        throw new SchemaException(
            "It is an error for the value specified " + "for minInclusive to be greater than "
                + "or equal to the value specified for " + "maxExclusive for the same datatype.");
      }
    }
    if (baseFacets != null) {
