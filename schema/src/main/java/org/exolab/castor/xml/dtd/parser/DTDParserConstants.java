...
public interface DTDParserConstants {
  ...
  String[] tokenImage = {"<EOF>", "<LETTER>", "<DIGIT>", "<COMBINING_CHAR>", "<EXTENDER>",
      "<NAMECHAR>", "<S>", "\"(\"", "\")\"", "\"|\"", "\",\"", "\"*\"", "\"?\"", "\"+\"", "\"ANY\"",
      "\"EMPTY\"", "\"<!ELEMENT\"", "\">\"", "\"#PCDATA\"", "\"<!ATTLIST\"", "\"<!--\"",
      "\"<!ENTITY\"", "\"<!NOTATION\"", "<NAME>", "<COMMENT_CHAR>", "\"-\"", "\"-->\"", "<S_ATTR>",
      "\"(\"", "\")\"", "\"|\"", "\"CDATA\"", "\"ID\"", "\"IDREF\"", "\"IDREFS\"", "\"ENTITY\"",
      "\"ENTITIES\"", "\"NMTOKEN\"", "\"NMTOKENS\"", "\"NOTATION\"", "\"#REQUIRED\"",
      "\"#IMPLIED\"", "\"#FIXED\"", "\"\\\"\"", "\"\\\'\"", "\">\"", "<NAME_ATTR>",
      "<NMTOKEN_ATTR>", "<ATTR_VALUE_CHAR_DQ>", "\"\\\"\"", "<ATTR_VALUE_CHAR_SQ>", "\"\\\'\"",
      "<S_GE>", "\">\"", "\"\\\"\"", "\"\\\'\"", "<PUBLIC_GE>", "<SYSTEM_GE>", "\"NDATA\"",
      "<NAME_GE>", "<SYSLITER_GE>", "<PUBIDCHAR_GE>", "<PUBLITER_GE>", "<S_GE_PUB>",
      "<GE_VAlUE_CHAR_DQ>", "\"\\\"\"", "<GE_VAlUE_CHAR_SQ>", "\"\\\'\"", "<S_NOT>", "<PUBLIC_NOT>",
      "<SYSTEM_NOT>", "<NAME_NOT>", "<SYSLITER_NOT>", "<S_NOT_SYS>", "\">\"", "<PUBIDCHAR_NOT>",
      "<PUBLITER_NOT>",};
