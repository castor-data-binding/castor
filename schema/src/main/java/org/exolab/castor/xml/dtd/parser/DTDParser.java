...
/**
 * Main XML DTD parser. Parses DTD documents with <b>parameter entity references</b> already
 * substituted by corresponding <b>replacement text</b>. Constructs DTD document object.
 * 
...
public class DTDParser implements DTDParserConstants {
  ...
  /**
   * Parsing procedure corresponding to the <b>Mixed Element Content</b> nonterminal.
   * 
  ...
  /**
   * Parsing procedure corresponding to the <b>Content Particle</b> nonterminal of the partial form:
   * choice list of content particles, or sequence list of content particles.
   * 
   * @return corresponding <b>Content Particle</b> object.
   */
  ...
  /**
   * Method to parse occurance specification of a <b>Content Particle</b>, that is "?", "*" or "+".
   * 
  ...
  /**
   * Parsing procedure corresponding to the <b>General Entity Declaration</b> nonterminal.
   * 
  ...
  final private boolean jj_3R_17() {
    if (jj_scan_token(BEGIN_COMMENT))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    Token xsp;
  ...
  final private boolean jj_3R_13() {
    if (jj_scan_token(BEGIN_ELEMENT_DECL))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    if (jj_scan_token(S))
  ...
  final private boolean jj_3_67() {
    if (jj_scan_token(LEFT_PAREN_ATTR))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    Token xsp;
    ...
    if (jj_scan_token(RIGHT_PAREN_ATTR))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    return false;
  ...
  final private boolean jj_3_91() {
    if (jj_scan_token(SYSTEM_NOT))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    if (jj_scan_token(SYSLITER_NOT))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    return false;
  ...
  final private boolean jj_3_90() {
    if (jj_scan_token(PUBLIC_NOT))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    if (jj_scan_token(PUBLITER_NOT))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    Token xsp;
  ...
  final private boolean jj_3R_16() {
    if (jj_scan_token(BEGIN_NOTATION_DECL))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    if (jj_scan_token(S_NOT))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    if (jj_scan_token(NAME_NOT))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    return false;
  ...
  final private boolean jj_3R_14() {
    if (jj_scan_token(BEGIN_ATTR_DECL))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    if (jj_scan_token(S_ATTR))
  ...
  final private boolean jj_3_85() {
    if (jj_scan_token(GE_VAlUE_CHAR_SQ))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    return false;
  ...
  final private boolean jj_3_84() {
    if (jj_scan_token(GE_VAlUE_CHAR_DQ))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    return false;
  ...
  final private boolean jj_3_79() {
    if (jj_scan_token(SYSTEM_GE))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    if (jj_scan_token(SYSLITER_GE))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    return false;
  ...
  final private boolean jj_3_78() {
    if (jj_scan_token(PUBLIC_GE))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    if (jj_scan_token(PUBLITER_GE))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    if (jj_scan_token(S_GE_PUB))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    return false;
  ...
  final private boolean jj_3R_15() {
    if (jj_scan_token(BEGIN_GE_DECL))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    if (jj_scan_token(S_GE))
  ...
  final private boolean jj_3_75() {
    if (jj_scan_token(ATTR_VALUE_CHAR_SQ))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    return false;
  ...
  final private boolean jj_3_77() {
    if (jj_scan_token(START_SQ_ATTR))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    Token xsp;
  ...
  final private boolean jj_3_74() {
    if (jj_scan_token(ATTR_VALUE_CHAR_DQ))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    return false;
  ...
  final private boolean jj_3_76() {
    if (jj_scan_token(START_DQ_ATTR))
      return true;
    if (jj_la == 0 && jj_scanpos == jj_lastpos)
      return false;
    Token xsp;
