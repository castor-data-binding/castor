...
public class EnumBindingType implements java.io.Serializable {
    ...
    public org.exolab.castor.builder.binding.EnumMember[] getEnumMember(
        ...
        org.exolab.castor.builder.binding.EnumMember[] array = new org.exolab.castor.builder.binding.EnumMember[0];
        return (org.exolab.castor.builder.binding.EnumMember[]) this._enumMemberList.toArray(array);
    }
     ...
     */
    public org.exolab.castor.builder.binding.EnumMember removeEnumMemberAt(
            final int index) {
