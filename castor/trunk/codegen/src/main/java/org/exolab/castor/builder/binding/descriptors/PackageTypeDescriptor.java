...
public class PackageTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public PackageTypeDescriptor() {
        ...
        //-- _packageTypeChoice
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.exolab.castor.builder.binding.PackageTypeChoice.class, "_packageTypeChoice", "-error-if-this-is-used-", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    PackageType target = (PackageType) object;
                    target.setPackageTypeChoice( (org.exolab.castor.builder.binding.PackageTypeChoice) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new org.exolab.castor.builder.binding.PackageTypeChoice();
            }
        };
        desc.setHandler(handler);
        desc.setContainer(true);
        desc.setClassDescriptor(new org.exolab.castor.builder.binding.descriptors.PackageTypeChoiceDescriptor());
        desc.setNameSpaceURI("http://www.castor.org/SourceGenerator/Binding");
        desc.setRequired(true);
        desc.setMultivalued(false);
        addFieldDescriptor(desc);
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.exolab.castor.builder.binding.PackageType.class;
    }
