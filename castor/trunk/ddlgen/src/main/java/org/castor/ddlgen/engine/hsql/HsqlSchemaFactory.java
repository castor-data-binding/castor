...
public final class HsqlSchemaFactory implements SchemaFactory {
     ...
     * {@inheritDoc}
     */
    public Table createTable() { return new HsqlTable(); }

    /**
     * {@inheritDoc}
     */
    public Field createField() { return new HsqlField(); }
     ...
     * {@inheritDoc}
     */
    public PrimaryKey createPrimaryKey() { return new HsqlPrimaryKey(); }
