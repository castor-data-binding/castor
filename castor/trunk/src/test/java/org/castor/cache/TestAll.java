...
public final class TestAll extends TestCase {
    public static Test suite() throws Exception {
        ...
        suite.addTest(org.castor.cache.distributed.TestAll.suite());
        suite.addTest(org.castor.cache.hashbelt.TestAll.suite());
        suite.addTest(org.castor.cache.simple.TestAll.suite());
