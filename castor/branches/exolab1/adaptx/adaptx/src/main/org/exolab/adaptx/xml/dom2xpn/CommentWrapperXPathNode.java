...
/**
 * A wrapper class for a Comment node, used by the
 * implementation of XPathNode for the W3C DOM API
 *
 * @author <a href="mailto:kvisco@ziplink.net">Keith Visco</a>
 * @version $Revision$ $Date$
**/
class CommentWrapperXPathNode extends BaseDOMXPathNode {

    /**
     * a reference to the comment this XPathNode wraps
    **/
    private Comment   _comment      = null;
    
    /**
     * Creates a new CommentWrapperXPathNode
     *
     * @param comment the W3C DOM Comment node to create the XPathNode
     * wrapper for.
    **/
    CommentWrapperXPathNode(Comment comment) {
        super();
        _comment = comment;    
    } //-- CommentWrapperXPathNode
