 ...
 * @since 1.3
 */
public final class Projection extends AbstractQueryObject {
    //--------------------------------------------------------------------------
     ...
     */
    public Projection(final Field field) {
        _field = field;
    }
     ...
     */
    public Projection(final Field field, final String alias) {
        _field = field;
        _alias = alias;
    }
    ...
    public StringBuilder toString(final StringBuilder sb) {
        if (_field instanceof SchemaImpl) {
            sb.append(((SchemaImpl) _field).getIdentifier());
        } else if (_field != null) {
            _field.toString(sb);
        } 
        if (_alias != null) {
