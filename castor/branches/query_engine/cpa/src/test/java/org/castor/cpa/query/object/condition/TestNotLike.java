...
/**
 * Junit Test for testing not like condition of query objects.
 * 
 ...
 * @since 1.3
 */
public class TestNotLike extends TestCase {
  //--------------------------------------------------------------
  ...
  //--------------------------------------------------------------
    ...
    public static void testWithString() {
        ...
        Condition condition = field.notLike("%test%");
        select.setWhere(condition);
        select.addSchema(schema);
        String expected = "o.position NOT LIKE '%test%'";
    ...
    public static void testWithStringChar() {
        ...
        select.setWhere(condition);
        select.addSchema(schema);
        String expected = "o.position NOT LIKE '%test%' ESCAPE '$'";
        assertEquals(_common + expected, select.toString());
        System.out.println(select.toString());
    }
    ...
    public static void testWithStringParam() {
        ...
        Condition condition = field.notLike("%test%", param);
        select.setWhere(condition);
        select.addSchema(schema);
        String expected = "o.position NOT LIKE '%test%' ESCAPE param";
        assertEquals(_common + expected, select.toString());
        System.out.println(select.toString());
    }
    ...
    public static void testWithParam() {
        ...
        Field field = schema.field("position");
        Parameter param = new MockParameter();
        Condition condition = field.notLike(param);
        select.setWhere(condition);
        select.addSchema(schema);
        String expected = "o.position NOT LIKE param";
        assertEquals(_common + expected, select.toString());
        System.out.println(select.toString());
    }
    ...
    public static void testWithParamChar() {
        ...
        select.setWhere(condition);
        select.addSchema(schema);
        String expected = "o.position NOT LIKE param ESCAPE '$'";
        assertEquals(_common + expected, select.toString());
        System.out.println(select.toString());
    }
    ...
    public static void testWithParamParam() {
        ...
        Condition condition = field.notLike(param, param2);
        select.setWhere(condition);
        select.addSchema(schema);
        String expected = "o.position NOT LIKE param ESCAPE param";
        assertEquals(_common + expected, select.toString());
        System.out.println(select.toString());
    }
