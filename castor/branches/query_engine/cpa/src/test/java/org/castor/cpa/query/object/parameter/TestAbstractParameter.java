...
/**
 * Junit test for testing AbstractParameter class.
 * 
...
public class TestAbstractParameter extends TestCase {
    ...
    /**
     * Instantiates a new junit Test for abstract parameter.
     * 
     * @param name the name
     */
    public TestAbstractParameter(final String name) {
       super(name);
    }
    ...
    public void testInstance() {
        QueryObject n = new MockParameter();
