...
/**
 * Junit Test for testing not between condition of query objects.
 * 
 ...
 * @since 1.3
 */
public class TestNotBetween extends TestCase {
  //--------------------------------------------------------------
 ...
 //--------------------------------------------------------------
    ...
    public static void testWithLong() {
        ...
        Condition condition = field.notBetween(2L, 3L);
        select.setWhere(condition);
        select.addSchema(schema);
        String expected = "o.position NOT BETWEEN 2 AND 3";
    ...
    public static void testWithDouble() {
        ...
        select.addProjection(schema.field("bar"));
        Field field = schema.field("position");
        Condition condition = field.notBetween(2.02d, 4.04d);
        select.setWhere(condition);
        select.addSchema(schema);
        String expected = "o.position NOT BETWEEN 2.02 AND 4.04";
        assertEquals(_common + expected, select.toString());
        System.out.println(select.toString());
    }
    ...
    public static void testWithBigDecimal() {
        ...
        select.addProjection(schema.field("bar"));
        Field field = schema.field("position");
        Condition condition = field.notBetween(new BigDecimal("12.34"), new BigDecimal("55.55"));
        select.setWhere(condition);
        select.addSchema(schema);
        String expected = "o.position NOT BETWEEN 12.34 AND 55.55";
        assertEquals(_common + expected, select.toString());
        System.out.println(select.toString());
    }
    ...
    public static void testWithString() {
        ...
        select.setWhere(condition);
        select.addSchema(schema);
        String expected = "o.position NOT BETWEEN 'LOW' AND 'HIGH'";
        assertEquals(_common + expected, select.toString());
        System.out.println(select.toString());
    }
    ...
    public static void testWithDateDate() {
        ...
        Condition condition = field.notBetween(TemporalType.DATE, l, h);
        select.setWhere(condition);
        select.addSchema(schema);
        String expected = "o.position NOT BETWEEN '2008-03-26' AND '2008-07-20'";
        assertEquals(_common + expected, select.toString());
        System.out.println(select.toString());
    }
    ...
    public static void testWithTimeDate() {
        ...
        Date h = new Date(1216545874266L);
        Date l = new Date(1206545874266L);
        Condition condition = field.notBetween(TemporalType.TIME, l, h);
        select.setWhere(condition);
        select.addSchema(schema);
        String expected = "o.position NOT BETWEEN '23:37:54.266' AND '17:24:34.266'";
        assertEquals(_common + expected, select.toString());
        System.out.println(select.toString());
    }
    ...
    public static void testWithTimestampDate() {
        ...
        Date h = new Date(1216545874266L);
        Date l = new Date(1206545874266L);
        Condition condition = field.notBetween(TemporalType.TIMESTAMP, l, h);
        select.setWhere(condition);
        select.addSchema(schema);
        String expected = 
            "o.position NOT BETWEEN '2008-03-26 23:37:54.266' AND '2008-07-20 17:24:34.266'";
        assertEquals(_common + expected, select.toString());
        System.out.println(select.toString());
    }
    ...
    public static void testWithExpression() {
        ...
        Condition condition = field.notBetween(l, h);
        select.setWhere(condition);
        select.addSchema(schema);
        String expected = "o.position NOT BETWEEN expression AND expression";
        assertEquals(_common + expected, select.toString());
        System.out.println(select.toString());
    }
