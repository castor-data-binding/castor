 ...
 */
public class RootTypeDescriptor extends org.exolab.castor.tests.framework.testDescriptor.descriptors.StringTypeDescriptor {
    ...
    public RootTypeDescriptor() {
        super();
        setExtendsWithoutFlatten(new org.exolab.castor.tests.framework.testDescriptor.descriptors.StringTypeDescriptor());
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                RootType target = (RootType) object;
                if (!target.hasRandom()) { return null; }
