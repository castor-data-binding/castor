 ...
 */
public class TestCreateOneToOne_NullAccepted extends CPATestCase {
    private final static String DBNAME = "test2860";
    private final static String MAPPING = "/org/castor/cpa/test/test2860/OneToOne_NullAccepted/mapping_create.xml";
    private Database _db;

    public TestCreateOneToOne_NullAccepted(final String name) {
	super(name);
    }
