 ...
 */
public class TestCreateManyToOne extends CPATestCase {
    private final static String DBNAME = "test2860";
    private final static String MAPPING = "/org/castor/cpa/test/test2860/ManyToOne/mapping_create.xml";
    private Database _db;
    
    public TestCreateManyToOne(final String name) {
	super(name);
    }
