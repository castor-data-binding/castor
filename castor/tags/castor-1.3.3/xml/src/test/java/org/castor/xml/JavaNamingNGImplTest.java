...
public class JavaNamingNGImplTest extends TestCase {
    ...
    public final void testToJavaMemberNameString() {
        ...
        Assert.assertEquals("first", _javaNaming.toJavaMemberName("first"));
        Assert.assertEquals("firstMember", _javaNaming.toJavaMemberName("first-member"));
    }
    ...
    public final void testToJavaMemberNameStringBoolean() {
        ...
        Assert.assertEquals("first", _javaNaming.toJavaMemberName("first", true));
        Assert.assertEquals("firstMember", _javaNaming.toJavaMemberName("first-member", true));

        Assert.assertEquals("class", _javaNaming.toJavaMemberName("class", false));
        Assert.assertEquals("clazz", _javaNaming.toJavaMemberName("class", true));
        
        Assert.assertEquals("native", _javaNaming.toJavaMemberName("native", true));
}
