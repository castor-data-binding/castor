...
public class CoherenceCache extends AbstractBaseCache {
     ...
     */
    private static Log _log = LogFactory.getFactory().getInstance(CoherenceCache.class);

    /** Coherence Cache factory class used during instantiation and shutdown */
    ...
    public String toString() {
        ...
        try {
            ...
            buffer.append("Error creating String representation of this object: " 
    ...
    protected String paramString() {
        StringBuffer buffer = new StringBuffer();
        buffer.append("name=" + invokeMethod (this._cache, "getCacheName", null, null));
        return buffer.toString();
    }
    ...
    public void initialize() throws CacheAcquireException {
        try {
            _factoryClass = 
                this.getClass().getClassLoader().loadClass(TANGOSOL_CACHE_FACTORY);
            
            // _log.error("Sucessfully instantiated class " + _factoryClass.getName());

            // this.cache = factory.getMapAccess( this.getClassName() );
            this._cache = invokeStaticMethodWithExceptions (_factoryClass, 
                    "getCache", 
    ...
    public void close() {
        ...
        try {
            if (_cache != null) {
                invokeMethod (this._cache, "release", null, null);
//                invokeMethod (this._cache, "destroy", null, null);
            }
//            if (_factoryClass != null) {
//                invokeStaticMethodWithExceptions(_factoryClass, "shutdown", null, null);
//            }
        } catch (Throwable t) {
            _log.fatal("Problem releasing Coherence cache ...", t);
        }
    }
