...
* For more details of FKache, see http://jcache.sourceforge.net 
* 
...
public class JCache extends AbstractBaseCache {
     ...
     */
    private static Log _log = LogFactory.getFactory().getInstance(JCache.class);
    ...
    public Enumeration elements() {
        Object enumeration = invokeMethod (this._cache, "keySet", null, null);
        return Collections.enumeration((Collection) enumeration);
    }
     ...
     */
    public int size() {
        Integer returnValue = (Integer) invokeMethod (this._cache,  "size", null, null);
    ...
    public void initialize() throws CacheAcquireException {
        try {
            ...
            Class factoryClass = Class.forName("javax.util.jcs.CacheAccessFactory");

            Object factory = invokeStaticMethodWithExceptions (factoryClass, 
