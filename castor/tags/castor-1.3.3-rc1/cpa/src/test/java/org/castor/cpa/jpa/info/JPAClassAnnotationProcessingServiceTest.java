...
public final class JPAClassAnnotationProcessingServiceTest {
    private JPAClassAnnotationProcessingService _processingService;

    @Before
    public void setUp() throws Exception {
        _processingService = new JPAClassAnnotationProcessingService();
    }
