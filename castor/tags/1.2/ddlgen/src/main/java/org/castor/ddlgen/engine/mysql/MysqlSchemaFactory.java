 ...
 * @since 1.1
 */
public final class MysqlSchemaFactory implements SchemaFactory {
    //--------------------------------------------------------------------------
    
    /**
     * {@inheritDoc}
     */
    public Schema createSchema() { return new MysqlSchema(); }

    /**
     * {@inheritDoc}
     */
    public Table createTable() { return new MysqlTable(); }

    /**
     * {@inheritDoc}
     */
    public Field createField() { return new MysqlField(); }

    /**
     * {@inheritDoc}
     */
    public ForeignKey createForeignKey() { return new MysqlForeignKey(); }
