...
insert into test93_subscription (id, created_date, customer_id) values (1, CURRENT_TIMESTAMP, 2);
insert into test93_subscription (id, created_date, customer_id) values (2, CURRENT_TIMESTAMP, 2);