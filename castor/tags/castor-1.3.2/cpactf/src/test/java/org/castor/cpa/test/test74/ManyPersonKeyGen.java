...
@Ignore
public final class ManyPersonKeyGen implements TimeStampable {
    ...
    public Collection < ManyGroupKeyGen > getGroup() {
        return _group;
    }

    public void setGroup(final Collection < ManyGroupKeyGen > group) {
        _group = group;
    }
