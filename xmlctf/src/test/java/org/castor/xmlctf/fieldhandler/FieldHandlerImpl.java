...
public class FieldHandlerImpl
    implements FieldHandler, ConfigurableFieldHandler, ClonableFieldHandler {
  ...
  public FieldHandler copyInstance() {
    FieldHandlerImpl fieldHandler = new FieldHandlerImpl();
    fieldHandler.setFormatter(this.getFormatter());
    return fieldHandler;
  }
