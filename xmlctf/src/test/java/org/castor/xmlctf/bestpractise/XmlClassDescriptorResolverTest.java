...
public class XmlClassDescriptorResolverTest extends TestCase {
  ...
  public void testWithMapping() {
    try {
      InputStream strmMapping =
          this.getClass().getClassLoader().getResourceAsStream("withmapping-mapping.xml");
      ...
      InputStream stream =
          this.getClass().getClassLoader().getResourceAsStream("withmapping-input.xml");
  ...
  public void testWithPackage() {
    try {
      XMLClassDescriptorResolver classDescriptorResolver =
          (XMLClassDescriptorResolver) ClassDescriptorResolverFactory
              .createClassDescriptorResolver(BindingType.XML);
      classDescriptorResolver.setClassLoader(XmlClassDescriptorResolverTest.class.getClassLoader());
      ...
      InputStream stream =
          this.getClass().getClassLoader().getResourceAsStream("genpackage-input.xml");
      Assert.assertNotNull("InputStream must not be null", stream);
      InputSource is = new InputSource(stream);
      Assert.assertNotNull("Inputstream must not be null", is);
      Object o = unmarshaller.unmarshal(is);
