 ...
 */
public class FailureDescriptor extends org.exolab.castor.tests.framework.testDescriptor.descriptors.FailureTypeDescriptor {
    ...
    public FailureDescriptor() {
        super();
        setExtendsWithoutFlatten(new org.exolab.castor.tests.framework.testDescriptor.descriptors.FailureTypeDescriptor());
