...
/**
 * Test the implementation of {@link NatureExtendable}. Subclasses MUST override the setUp method
 * and set a {@link NatureExtendable} to _extender. The test case needs a "fresh"
 * {@link NatureExtendable} to guarantee independence for each test.
 * 
 * @author Lukas Lang
 * @since 1.2.1
 */
