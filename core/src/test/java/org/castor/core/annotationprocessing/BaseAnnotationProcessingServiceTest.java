...
public class BaseAnnotationProcessingServiceTest extends TestCase {
  ...
  /**
   * This is a {@link AnnotationProcessor} that actually does nothing, except telling that it
   * processed the given Annotation if it was of Type {@link SupportedAnnotation}. It's just a
   * dummy.
   */
