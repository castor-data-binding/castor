...
public interface TargetAwareAnnotationProcessor extends AnnotationProcessor {
  ...
  /**
   * The processing action of this processor. If an annotation is given which is not supported false
   * is returned.
   * 
   * @param info the Info class that should be filled with the information read
   * @param annotation the annotation to process
   * @param target the target ({@link Field}, {@link Class}, etc.) of the given annotation
   ...
   */
  <I extends BaseNature, A extends Annotation> boolean processAnnotation(I info, final A annotation,
