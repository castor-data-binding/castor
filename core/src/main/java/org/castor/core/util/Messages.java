...
/**
 * I18N message formatting class. A static factory for obtaining messages and formatting messages
 * with arguments.
 * <p>
 * The resource file <tt>org.exolab.castor.util.resources.messages</tt> contains a list of all the
 * messages in English. Additional resource files can be added for other languages and locales by
 * placing them in the same package with a language/locale prefix. See the I18N documentation and
 * use of resource bundles in the JDK docs.
 *
...
public final class Messages {
  ...
  /**
   * The name of the resource holding all the messages in the English language. Resources for other
   * languages and locales use the same name with a language/locale prefix.
   */
  ...
  /**
   * Set the default locale to use for loading messages. Calling this method will reload all the
   * messages based on the new locale name.
   */
  ...
  /**
   * Set the locale to use for loading messages. Calling this method will reload all the messages
   * based on the new locale name.
   * 
   ...
   * @return The full message text
   */
  public static String format(final String message, final Object arg1, final Object arg2) {
   ...
   */
  private static class EmptyResourceBundle extends ResourceBundle implements Enumeration<String> {
    /**
     * {@inheritDoc}
     * 
