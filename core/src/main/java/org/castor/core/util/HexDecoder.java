...
public final class HexDecoder {
   ...
   * Encoding table.
   */
  protected static final byte[] ENCODING_TABLE = {(byte) '0', (byte) '1', (byte) '2', (byte) '3',
  ...
  /**
   * Decodes the Hex encoded byte data writing it to the given output stream, whitespace characters
   * will be ignored.
   * 
  ...
  /**
   * Decodes the Hex encoded String data writing it to the given output stream, whitespace
