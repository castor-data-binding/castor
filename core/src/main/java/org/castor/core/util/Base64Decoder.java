...
public final class Base64Decoder {
  ...
  private static final byte[] MAP = {SPC, SPC, SPC, SPC, SPC, SPC, SPC, SPC, // 00-07
  ...
  /**
   * Translate every base64 character from given string into a sextet byte value by using above
   * translation array. The sextets are then shiftet into an buffer until the buffer contains 4
   * sextets which are then decoded into 3 octets. The translate and decode process is continued
   * until all characters of given string are evaluated. If there are remaing sextets in the buffer
   * they also will be converted into octets at the end. All the converted octets are added to the
   * list for later read.
   * 
