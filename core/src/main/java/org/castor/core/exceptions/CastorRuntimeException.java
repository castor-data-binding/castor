...
public class CastorRuntimeException extends RuntimeException {
  ...
  /**
   * Constructs a new Castor runtime exception without a message. The cause is not initialized but
   * may subsequently be initialized by a call to initCause(Throwable).
   */
  ...
  /**
   * Constructs a new Castor runtime exception with the specified detail message. The cause is not
   * initialized but may subsequently be initialized by a call to initCause(Throwable).
   * 
  ...
  /**
   * Constructs a new Castor runtime exception with the specified cause and the detail message of
   * the cause. This constructor is useful for exceptions that are wrappers for others.
   * 
  ...
  /**
   * The method emulates the JDK 1.4 Throwable version of initCause() for JDKs before 1.4. <br/>
   * {@inheritDoc}
   */
  ...
  /**
   * The method emulates the JDK 1.4 Throwable version of getCause() for JDKs before 1.4. <br/>
   * {@inheritDoc}
   */
