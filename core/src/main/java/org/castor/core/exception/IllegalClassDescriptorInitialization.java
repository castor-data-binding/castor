...
/**
 * {@link RuntimeException} descendant to signal problems during class descriptor instantiation.
 * 
...
public class IllegalClassDescriptorInitialization extends RuntimeException {
   ...
   * @param cause Root exception
   */
  public IllegalClassDescriptorInitialization(final String message, final Throwable cause) {
    super(message, cause);
  }
