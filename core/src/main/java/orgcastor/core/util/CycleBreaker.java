 ...
 * </p>
 * <ol>
 * <li>startingToCycle is called on a particular object prior to recursing on it, and recursion
 * should only occur if this call returns false.</li>
 * <li>releaseCycleHandle is called after the recursive call returns in order to release the cycle
 * lock on the object.</li>
 * </ol>
 * <p>
 * <strong>Note :</strong> Do not use this cycle breaking mechanism on object comparisons where two
 * instances may share the same reference to some third object, such as a String constant.
 * </p>
 * 
...
public class CycleBreaker {
  ...
  /**
   * Called to release Cycling lock for this object at the end of a routine where cycles are to be
   * detected.
   * 
