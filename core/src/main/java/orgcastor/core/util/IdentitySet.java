...
/**
 * An IdentitySet that uses reference-equality instead of object-equality. According to its special
 * function it violates some design contracts of the <code>Set</code> interface.
 * 
...
public final class IdentitySet implements Set {
  ...
  public Object[] toArray(final Object[] a) {
    ...
    if (result.length < _entries) {
      result = (Object[]) java.lang.reflect.Array.newInstance(result.getClass().getComponentType(),
          _entries);
    }
  ...
  /**
   * In contrast with the design contract of the <code>Set</code> interface this method has not been
   * implemented and throws a <code>UnsupportedOperationException</code>.
   * 
   * {@inheritDoc}
   * 
  ...
  private class IdentityIterator implements Iterator {
    ...
    /**
     * This optional method is not implemented for <code>IdentityIterator</code> instead it throws a
     * <code>UnsupportedOperationException</code> as defined in the <code>Iterator</code> interface.
     * 
