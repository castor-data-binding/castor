...
public final class PropertiesException extends CastorRuntimeException {
  ...
  /**
   * Constructs a new PropertiesException without a message. The cause is not initialized but may
   * subsequently be initialized by a call to initCause(Throwable).
   */
  ...
  /**
   * Constructs a new PropertiesException with the specified detail message. The cause is not
  ...
  /**
   * Constructs a new PropertiesException with the specified cause and the detail message of the
   * cause. This constructor is useful for exceptions that are wrappers for others.
   * 
