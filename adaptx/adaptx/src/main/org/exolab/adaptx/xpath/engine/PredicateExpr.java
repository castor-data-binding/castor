    ...
    extends XPathExpression
{
    ...
    private PredicateExpr _next = null;


    /**
     * Creates a new PredicateExpr using the given Expr
    **/
    public PredicateExpr(XPathExpression expr)
    ...
    **/
    ...
    /**
     * Returns the next expr in this PredicateExpr
     * @returns the next expr in this PredicateExpr
    **/
    ...
    public void setNext( PredicateExpr expr )
        throws XPathException
    {
        if ( expr== null )
            throw new XPathException( "Argument expr is null" );
