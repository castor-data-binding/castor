...
public class XMLContext {
  ...
  /**
   * The internal XML context is the class which holds a couple of Castor states as it provides some
   * central methods needed in various places of Castor.
   */
   ...
   * when no mapping is used, as happens when the domain classes has been generated using the XML
   ...
   * 
   * @return A new {@link Unmarshaller} instance, preconfigured with a
   *         {@link XMLClassDescriptorResolver} instance with the class descriptors cached as loaded
   *         above.
   */
  ...
  /**
   * To get the {@link InternalContext} as used when instantiating other classes. Mind that this
   * method is only used in tests and should NOT be used in production code!
   * 
