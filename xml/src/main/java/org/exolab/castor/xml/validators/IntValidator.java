...
/**
 * The Int Validation class. This class handles validation for the primitive <code>int</code> and
 * <code>java.lang.Integer</code> types as well as all derived types such as unsigned-short.
 *
...
public class IntValidator extends PatternValidator implements TypeValidator {
   ...
   * max/min range, then no int will pass validation. This is as according to the XML Schema spec.
   *
   * @param fixedValue the fixed value that a int validated with this validator must be equal to.
   */
  ...
  /**
   * Sets the minimum (exclusive) value for int validation. To pass validation, a int must be
   * greater than this value.
   *
   * @param minValue the minimum (exclusive) value for int validation.
   */
  ...
  /**
   * Sets the minimum (inclusive) value for int validation. To pass validation, a int must be
   * greater than or equal to this value.
   *
   * @param minValue the minimum (inclusive) value for int validation.
   */
  ...
  /**
   * Sets the maximum (exclusive) value for int validation. To pass validation, a int must be less
   * than this value.
   *
   * @param maxValue the maximum (exclusive) value for int validation.
   */
  ...
  /**
   * Sets the maximum (inclusive) value for int validation. To pass validation, a int must be less
   * than or equal to this value.
   *
   * @param maxValue the maximum (inclusive) value for int validation.
   */
  ...
  /**
   * Sets the maximum number of digits for int validation. To pass validation, a int must have this
   * many digits or fewer. Leading zeros are not counted.
   *
   * @param totalDig the maximum (inclusive) number of digits for int validation. (must be > 0)
   */
   ...
   *
   * @param i the long to validate
   * @param context the ValidationContext
   * @throws ValidationException if the object fails validation.
   */
  public void validate(final int i, final ValidationContext context) throws ValidationException {
    ...
    if (_totalDigits != -1) {
      ...
      if (length > _totalDigits) {
        String err =
            "int " + i + " has too many digits -- must have " + _totalDigits + " digits or fewer.";
        throw new ValidationException(err);
      }
    }
