 ...
 * @since 1.1
 */
public abstract class BaseXercesJDK5Serializer implements org.exolab.castor.xml.Serializer {
  ...
  public BaseXercesJDK5Serializer() {
    try {
      _serializer = Class.forName(getPackageName() + ".XMLSerializer").newInstance();
    } catch (Exception except) {
      throw new RuntimeException(Messages.format("conf.failedInstantiateSerializer",
          getPackageName() + ".XMLSerializer", except));
    }
  }
  ...
  /**
   * @see org.exolab.castor.xml.Serializer#setOutputCharStream(java.io.Writer) {@inheritDoc}
   */
  ...
  /**
   * @see org.exolab.castor.xml.Serializer #setOutputFormat(org.exolab.castor.xml.OutputFormat)
   *      {@inheritDoc}
   */
  public void setOutputFormat(final OutputFormat format) {
    Method method;
    try {
      Class outputFormatClass = Class.forName(getPackageName() + ".OutputFormat");
  ...
  /**
   * @see org.exolab.castor.xml.Serializer#setOutputByteStream(java.io.OutputStream) {@inheritDoc}
   */
  public void setOutputByteStream(final OutputStream output) {
    Method method;
    try {
      method =
          _serializer.getClass().getMethod("setOutputByteStream", new Class[] {OutputStream.class});
