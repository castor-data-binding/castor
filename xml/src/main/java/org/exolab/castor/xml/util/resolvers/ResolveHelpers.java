...
/**
 * Some helpers used by the resolver commands. This is a utility class which is NOT meant to be
 * instantiated.
 * 
...
public final class ResolveHelpers {
  ...
  /**
   * Gets the <code>ClassLoader</code> that's actually to be used (e.g. for loading resources).<br>
   * The actual <code>ClassLoader</code> is determined in the following way: <lu>
   * <li>If the passed in "preferred" loader is not <code>null</code>, it is used.
   * <li>If the loader of this XMLClassDescriptor is not <code>null</code>, it is used.
  ...
  /**
   * Capsulates the ClassLoader.loadClass method to throw no exceptions but return null instead. Any
   * exception caught are logged with info severity.
   * 
  ...
  public static Class loadClass(ClassLoader classLoader, String className) {
    ...
    try {
      ...
      if (LOG.isDebugEnabled()) {
        LOG.debug("Ignored problem at loading class: " + className + " through class loader: "
