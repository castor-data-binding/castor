...
/**
 * Resolve a class by looking for a descriptor class 'nearby'. The descriptor class has to follow
 * some specific naming conventions (and maybe be in a special package).
 * 
