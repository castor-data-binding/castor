...
public class BaseXercesOutputFormat implements OutputFormat {
  ...
  public void setDoctype(final String type1, final String type2) {
    Method method;
    try {
      method = _outputFormat.getClass().getMethod("setDoctype",
  ...
  public void setOmitXMLDeclaration(final boolean omitXMLDeclaration) {
    ...
    try {
      method =
          _outputFormat.getClass().getMethod("setOmitXMLDeclaration", new Class[] {boolean.class});
  ...
  public void setOmitDocumentType(final boolean omitDocumentType) {
    Method method;
    try {
      method = _outputFormat.getClass().getMethod("setOmitDocumentType", boolean.class);
  ...
  public void setEncoding(final String encoding) {
    Method method;
    try {
      method = _outputFormat.getClass().getMethod("setEncoding", String.class);
  ...
  public void setVersion(final String version) {
    Method method;
    try {
      method = _outputFormat.getClass().getMethod("setVersion", new Class[] {String.class});
