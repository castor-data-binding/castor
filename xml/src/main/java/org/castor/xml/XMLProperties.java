...
public class XMLProperties extends AbstractProperties {
   ...
   * 'attribute'.
   * 
   * Possible values: - 'element' - 'attribute' (default)
   * 
   * <pre>
  ...
  /**
   * Property specifying the 'type' of the XML naming conventions to use. Values of this property
   * must be either "mixed", "lower", or the name of a class which extends
   * {@link org.exolab.castor.xml.AbstractXMLNaming}.
   * 
  ...
  /**
   * Property specifying the 'type' of the Java naming conventions to use. Values of this property
   * must be either null or the name of a class which extends {@link org.castor.xml.JavaNaming}.
   * 
   * Possible values: - null - A class name (which extends {@link org.castor.xml.JavaNaming}).
   * 
   * <pre>
  ...
  /**
   * Property specifying additional features for the XML parser. This value contains a comma
   * separated list of features that might or might not be supported by the specified SAX parser.
   * 
   * <pre>
  ...
  /**
   * Property specifying features to be disabled on the underlying SAX parser. This value contains a
   * comma separated list of features to be disabled.
   * 
   * <pre>
  ...
  /**
   * Property specifying the regular expression validator to use. The specified class must implement
  ...
  /**
   * Property specifying whether to apply strictness to elements when unmarshalling. Default is true
   * which means that elements appearing in the XML document, which cannot be mapped to a class,
   * cause a {@link SAXException} to be thrown. If set to false, these 'unknown' elements are
   * ignored.
   * 
   * Possible values: - false - true (default)
   * 
  ...
  /**
   * Property specifying whether or not to save the "keys" of a {@link Hashtable} or {@link Map}
  ...
  /**
   * Property specifying whether or not to search for an proxy interface at marshalling. If property
   * is not empty the objects to be marshalled will be searched if they implement one of the given
   * interface names. If the interface is implemented the superclass will be marshalled instead of
   * the class itself.
   * 
   * <pre>
  ...
  /**
   * The property name for enabling collection wrapping. The property controls whether or not
   * collections (arrays, vectors, etc) should be wrapped in a container element. For example:
   *
   * <pre>
   *    &lt;foos&gt;
   *       &lt;foo&gt;foo1&lt;/foo&gt;
   ...
   * </pre>
   */
  public static final String XML_VERSION = "org.exolab.castor.xml.version";
