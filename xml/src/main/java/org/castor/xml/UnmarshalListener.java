 ...
 * registered with the Unmarshaller.<br/>
 * This is already a new version of this interface with enhanced callback methods. The orginial
 * implementation still exists but is deprecated {@link org.exolab.castor.xml.UnmarshalListener}.
 * <p/>
 * The UnmarshalListener interface does <em>not</em> report on native data types that are
 * unmarshalled.
 * <p/>
 * The first definition of this interface was by <a href="mailto:paul@priorartisans.com">Paul
 * Christmann</a>, <a href="mailto:kvsico@intalio.com">Keith Visco</a> and
...
public interface UnmarshalListener {
  ...
  /**
   * This method is called when an object has just been initialized by the {@link Unmarshaller}.
   *
  ...
  /**
   * This method is called once the attributes have been processed. It indicates that the the fields
   * of the given object corresponding to attributes in the XML document have been set.
   *
  ...
  /**
   * This method is called after a child object has been added during the unmarshalling. This method
   * will be called after {@link #unmarshalled(Object)} has been called for the child.
   *
