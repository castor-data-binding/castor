...
public final class MappingLoaderRegistry {
  ...
  private final List<MappingLoaderFactory> _mappingLoaderFactories =
      new ArrayList<MappingLoaderFactory>();
  ...
  /**
   * Returns a mapping loader for the suitable source and binding type. The engine's specific
   * mapping loader is used to create binding specific descriptors. The mapping loader is cached in
   * memory and returned in subsequent method calls.
   *
   ...
   * @throws MappingException A mapping error occurred preventing descriptors from being generated
   *         from the loaded mapping
   */
  public MappingLoader getMappingLoader(final String sourceType, final BindingType bindingType)
    ...
    String msg = "No mapping loader/factory for: " + "SourceType=" + sourceType + " / BindingType="
        + bindingType;
    LOG.error(msg);
