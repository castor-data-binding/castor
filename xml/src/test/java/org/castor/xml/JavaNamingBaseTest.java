...
public abstract class JavaNamingBaseTest {
	...
	public final void testIsKeyword() {
	    ...
	    for (int i = 0; i < VALID_NAMES.length; i++) {
	        ...
	        Assert.assertFalse(
	                "Name: " + aName + " is no keyword!", javaNaming.isKeyword(aName));
	    }
	}
	...
	public final void testIsValidJavaIdentifier() {
	    Assert.assertFalse(
	            "A null String is no identifier", javaNaming.isValidJavaIdentifier(null));
	    Assert.assertFalse(
	            "An empty String is no identifier", javaNaming.isValidJavaIdentifier(""));
	    for (int i = 0; i < VALID_NAMES.length; i++) {
	        String aName = VALID_NAMES[i];
	        Assert.assertTrue(
	                "Name: " + aName + " should be valid!", javaNaming.isValidJavaIdentifier(aName));
	    }
	    for (int i = 0; i < INVALID_NAMES.length; i++) {
	        String aName = INVALID_NAMES[i];
	        Assert.assertFalse(
	                "Name: " + aName + " should be invalid!", javaNaming.isValidJavaIdentifier(aName));
	    }
	}
	...
	public final void testToJavaClassName() {
	    Assert.assertEquals("For null in and out should be equals", null, javaNaming.toJavaClassName(null));
	    Assert.assertEquals("For an empty string in and out should be equals", "", javaNaming.toJavaClassName(""));
	}
	...
	public final void testToJavaMemberNameString() {
	    Assert.assertEquals("For null in and out should be equals", null, javaNaming.toJavaMemberName(null));
	    Assert.assertEquals("For an empty string in and out should be equals", "", javaNaming.toJavaMemberName(""));
	...
	public final void testToJavaMemberNameStringBoolean() {
	        Assert.assertEquals("For null in and out should be equals", null, javaNaming.toJavaMemberName(null, true));
	        Assert.assertEquals("For an empty string in and out should be equals", "", javaNaming.toJavaMemberName("", true));
	        Assert.assertEquals("For null in and out should be equals", null, javaNaming.toJavaMemberName(null, false));
	        Assert.assertEquals("For an empty string in and out should be equals", "", javaNaming.toJavaMemberName("", false));
	...
	public final void testPackageToPath() {
	    Assert.assertEquals("For null in and out should be equals", null, javaNaming.packageToPath(null));
	    Assert.assertEquals("For an empty string in and out should be equals", "", javaNaming.packageToPath(""));
	...
	public final void testGetQualifiedFileName() {
	    Assert.assertEquals("For null in and out should be equals", null, javaNaming.getQualifiedFileName(null, null));
	    Assert.assertEquals("For an empty string in and out should be equals", "", javaNaming.getQualifiedFileName("", ""));
	    Assert.assertEquals("For an empty string in and out should be equals", null, javaNaming.getQualifiedFileName(null, ""));
	    Assert.assertEquals("For an empty string in and out should be equals", "", javaNaming.getQualifiedFileName("", null));
	...
	public final void testGetPackageName() {
	    Assert.assertEquals("For null in and out should be equals",
	            null, javaNaming.getPackageName(null));
	...
	public final void testGetClassName() {
	    ...
	    Assert.assertEquals("JavaNamingNGImplTest", javaNaming.getClassName(JavaNamingNGImplTest.class));
	    Assert.assertEquals("JavaNamingNGImplTest$ForTestingPurposes", javaNaming.getClassName(ForTestingPurposes.class));
	}
