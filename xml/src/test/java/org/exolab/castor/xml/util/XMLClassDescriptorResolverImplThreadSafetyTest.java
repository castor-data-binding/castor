 ...
 * <p>
 * <b>Only useful on multi-core systems!!!</b>
 * </p>
 *
...
public class XMLClassDescriptorResolverImplThreadSafetyTest extends MultithreadedTestCase {
  ...
  private XMLClassDescriptor createMockDescriptor(String className) {
    XMLClassDescriptor descriptor = EasyMock.createMock(className, XMLClassDescriptor.class);
    EasyMock.expect(descriptor.getXMLName()).andReturn(className).anyTimes();
